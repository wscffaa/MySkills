...
def _find_credentials() -> str | None:
    ...
    candidates = [
        os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "credentials", "search.json"),
        os.path.expanduser("~/.gemini/antigravity/skills/search-layer/credentials/search.json"),
